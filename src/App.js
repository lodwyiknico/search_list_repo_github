    ...
    <div className="container mx-auto md:px-20">
     ...
     {loading ?
      <div className="flex justify-center items-center">
        <svg role="status" className="inline mr-2 w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
